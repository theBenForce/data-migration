...
swallow-cli/1.0.2 darwin-x64 node-v10.16.0
...
_See code: [src/commands/init.ts](https://github.com/drg-adaptive/swallow-migration/blob/v1.0.2/src/commands/init.ts)_
<!-- commandsstop -->
